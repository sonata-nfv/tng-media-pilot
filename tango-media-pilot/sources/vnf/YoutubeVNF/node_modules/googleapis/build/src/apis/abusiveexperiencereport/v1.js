 ...
 */
var Abusiveexperiencereport = /** @class */ (function () {
    function Abusiveexperiencereport(options, google) {
        this.root = this;
    ...
    Abusiveexperiencereport.prototype.getRoot = function () {
        return this.root;
    };
    return Abusiveexperiencereport;
}());
...
var Resource$Violatingsites = /** @class */ (function () {
    function Resource$Violatingsites(root) {
        this.root = root;
        this.getRoot.bind(this);
    }
    Resource$Violatingsites.prototype.getRoot = function () {
        return this.root;
    };
    Resource$Violatingsites.prototype.list = function (params, options, callback) {
        if (typeof options === 'function') {
            callback = options;
            options = {};
        }
    ...
    return Resource$Violatingsites;
}());
exports.Resource$Violatingsites = Resource$Violatingsites;
