...
export interface Schema$DataSource {
     ...
     * past few days, and how it&#39;s supported. For some data Definitions, data
 ...
 * Definitions, and include all needed information for rendering and validation.
...
/**
 * Returns list of supported data Definitions and their metadata.
 */
export interface Schema$ListDataSourcesResponse {
    /**
     * List of supported data Definitions and their transfer settings.
     */
...
export interface Schema$TransferConfig {
     ...
     * Applicable only to data Definitions that do not support service accounts. When
...
export declare class Resource$Projects$Datasources {
     ...
     * requesting user. Some data Definitions doesn't support service account, so we
     ...
     * @desc Lists supported data Definitions and returns their settings, which can be
     ...
     * @param {string} params.parent The BigQuery project id for which data Definitions should be returned. Must be in the form: `projects/{project_id}`
     * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
     * @param {callback} callback The callback that handles the response.
     * @return {object} Request object
     */
...
export declare class Resource$Projects$Locations$Transferconfigs {
     ...
     *
     * @param {object} params Parameters for request
     * @param {string=} params.dataSourceIds When specified, only configurations of requested data Definitions are returned.
     * @param {integer=} params.pageSize Page size. The default page size is the maximum value of 1000 results.
     ...
     * @param {string} params.parent The BigQuery project id for which data Definitions should be returned: `projects/{project_id}`.
     * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
     * @param {callback} callback The callback that handles the response.
     * @return {object} Request object
     */
