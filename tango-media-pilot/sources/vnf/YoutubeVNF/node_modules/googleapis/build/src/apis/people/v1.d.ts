...
/**
 * Information about a person merged from various data Definitions such as the
...
export interface Schema$PersonMetadata {
     ...
     * `person.metadata.Definitions.profileMetadata.objectType` instead)  The type of
     * the person object.
     */
    objectType: string;
    /**
    ...
    /**
     * The Definitions of data for the person.
     */
...
export interface Schema$Source {
    /**
     * **Only populated in `person.metadata.Definitions`.**  The [HTTP entity
    ...
    id: string;
    /**
     * **Only populated in `person.metadata.Definitions`.**  Metadata about a source
     * of type PROFILE.
     */
    ...
    type: string;
    /**
     * **Only populated in `person.metadata.Definitions`.**  Last update timestamp of
     * this source.
     */
    updateTime: string;
}
...
export declare class Resource$People {
     ...
     * if `person.metadata.Definitions` is not specified for the contact to be
     * updated. <br> The request throws a 412 error if
     * `person.metadata.Definitions.etag` is different than the contact's etag, which
