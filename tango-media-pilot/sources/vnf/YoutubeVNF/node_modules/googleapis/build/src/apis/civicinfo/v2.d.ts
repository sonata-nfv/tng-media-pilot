...
export interface Schema$AdministrationRegion {
    ...
    name: string;
    /**
     * A list of Definitions for this area. If multiple Definitions are listed the data
     * has been aggregated from those Definitions.
     */
...
export interface Schema$Contest {
    ...
    roles: string[];
    /**
     * A list of Definitions for this contest. If multiple Definitions are listed, the
     * data has been aggregated from those Definitions.
     */
    sources: Schema$Source[];
    /**
...
export interface Schema$Office {
    ...
    roles: string[];
    /**
     * A list of Definitions for this office. If multiple Definitions are listed, the data
     * has been aggregated from those Definitions.
     */
    sources: Schema$Source[];
}
...
export interface Schema$PollingLocation {
    ...
    pollingHours: string;
    /**
     * A list of Definitions for this location. If multiple Definitions are listed the
     * data has been aggregated from those Definitions.
     */
    sources: Schema$Source[];
    /**
...
export declare class Resource$Elections {
     ...
     * @param {boolean=} params.officialOnly If set to true, only data from official state Definitions will be returned.
