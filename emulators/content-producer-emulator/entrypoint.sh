...
FFREPORT=file=ffreport.log:repeat+verbose ffmpeg -loglevel repeat+verbose -stream_loop -1 -re -i /app/video1.mkv -c:v copy -c:a copy -g 60 -f flv rtmp://$AGGREGATOR:1935/$APP/$STREAM
