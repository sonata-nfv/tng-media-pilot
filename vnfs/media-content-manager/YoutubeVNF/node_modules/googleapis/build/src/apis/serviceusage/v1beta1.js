 ...
 */
var Serviceusage = /** @class */ (function () {
    function Serviceusage(options, google) {
        this.root = this;
    ...
    Serviceusage.prototype.getRoot = function () {
        return this.root;
    };
    return Serviceusage;
}());
...
var Resource$Services = /** @class */ (function () {
    ...
    Resource$Services.prototype.batchEnable = function (params, options, callback) {
        if (typeof options === 'function') {
            callback = options;
            options = {};
        }
