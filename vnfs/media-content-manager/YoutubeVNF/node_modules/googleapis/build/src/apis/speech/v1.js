...
var Speech = /** @class */ (function () {
    function Speech(options, google) {
        this.root = this;
    ...
    Speech.prototype.getRoot = function () {
        return this.root;
    };
    return Speech;
}());
...
var Resource$Speech = /** @class */ (function () {
    function Resource$Speech(root) {
        this.root = root;
        this.getRoot.bind(this);
    }
    Resource$Speech.prototype.getRoot = function () {
        return this.root;
    };
    Resource$Speech.prototype.longrunningrecognize = function (params, options, callback) {
        if (typeof options === 'function') {
            callback = options;
            options = {};
        }
    ...
    Resource$Speech.prototype.recognize = function (params, options, callback) {
        if (typeof options === 'function') {
            callback = options;
            options = {};
        }
...
exports.Resource$Speech = Resource$Speech;
