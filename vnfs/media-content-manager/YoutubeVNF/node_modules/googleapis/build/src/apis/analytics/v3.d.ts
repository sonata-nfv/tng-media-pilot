...
export declare class Resource$Management$Customdatasources {
     ...
     * @desc List custom data Definitions to which the user has access.
     * @alias analytics.management.customDataSources.list
     * @memberOf! ()
     *
     * @param {object} params Parameters for request
     * @param {string} params.accountId Account Id for the custom data Definitions to retrieve.
     * @param {integer=} params.max-results The maximum number of custom data Definitions to include in this response.
     ...
     * @param {string} params.webPropertyId Web property Id for the custom data Definitions to retrieve.
     * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
     * @param {callback} callback The callback that handles the response.
     * @return {object} Request object
     */
