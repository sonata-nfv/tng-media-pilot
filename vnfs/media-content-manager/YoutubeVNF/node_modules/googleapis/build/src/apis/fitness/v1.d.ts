...
export interface Schema$AggregateBy {
    ...
    dataSourceId: string;
    /**
     * The data type to aggregate. All data Definitions providing this data type will
...
/**
 * Definition of a unique source of sensor data. Data Definitions can expose raw
 ...
 * Definitions. Multiple data Definitions can exist for the same data type. Every data
...
export interface Schema$DataSource {
     ...
     * data Definitions of the same type from the same underlying producer. Setting
...
export declare class Resource$Users$Dataset {
     ...
     * multiple Definitions can be aggreated into exactly one bucket type per request.
...
export declare class Resource$Users$Datasources {
     ...
     * @desc Creates a new data source that is unique across all data Definitions
     ...
     * @desc Lists all data Definitions that are visible to the developer, using the
     * OAuth scopes provided. The list is not exhaustive; the user may have
     * private data Definitions that are only visible to other developers, or calls
     * using other scopes.
     * @alias fitness.users.dataSources.list
     * @memberOf! ()
     *
     * @param {object} params Parameters for request
     * @param {string=} params.dataTypeName The names of data types to include in the list. If not specified, all data Definitions will be returned.
     * @param {string} params.userId List data Definitions for the person identified. Use me to indicate the authenticated user. Only me is supported at this time.
     * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
     * @param {callback} callback The callback that handles the response.
     * @return {object} Request object
     */
     ...
     * be modified.  Data Definitions are identified by their dataStreamId. This
     ...
     * @desc Updates the specified data source. The dataStreamId, dataType, type,
     * dataStreamName, and device properties with the exception of version, cannot
     * be modified.  Data Definitions are identified by their dataStreamId.
