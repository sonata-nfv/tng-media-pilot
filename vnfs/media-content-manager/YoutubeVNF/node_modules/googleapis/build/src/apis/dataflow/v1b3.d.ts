 ...
 * encapsulates a set of other Definitions.
 */
 ...
 * stage of execution.  Some composing transforms and Definitions may have been
...
export interface Schema$ExecutionStageSummary {
    ...
    id: string;
    /**
     * Input Definitions for this stage.
     */
    ...
    name: string;
    /**
     * Output Definitions for this stage.
     */
 ...
 * metrics accumulated from a variety of Definitions. For more information, see
...
export interface Schema$SideInputInfo {
     ...
     * If more than one source, then the elements are taken from the Definitions, in
...
export interface Schema$Source {
    /**
     * While splitting, Definitions may specify the produced bundles as differences
